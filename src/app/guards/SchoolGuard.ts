import type { room, school, schoolAddress } from "@prisma/client";
import Joi from "joi";
import type { Address, Room, School } from "../interfaces/school.js";

export class TypeGuardSchool {
  async typeGuardSchoolCreate(school: School) {
    const schoolSchema = Joi.object<School, false, School>({
